...
public class SerializeBlobBase64 extends JsonSerializer<Blob> {

    Logger log1=LoggerFactory.getLogger(SerializeBlobBase64.class);
    @Override
    public void serialize(Blob data, JsonGenerator result, SerializerProvider provider)
        ...
        try {
            ...
            result.writeString(Base64.getEncoder().encodeToString(blob1));
